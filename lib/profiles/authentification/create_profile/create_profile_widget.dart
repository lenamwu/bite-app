                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              if (_model.uploadedFileUrl_uploadDataIo7 !=
                                      null &&
                                          ...
                                          onTapUp: (details) async {
                                            ...
                                            if (selectedMedia != null &&
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataIo7 =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataIo7 =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataIo7 =
                                                      downloadUrls.first;
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.uploadedLocalFile_uploadDataIo7 ==
                                      null ||
                                  (_model.uploadedLocalFile_uploadDataIo7
                                              .bytes ??
                                          [])
                              ...
                              if (buttonUsernamesRecord?.usernamesInUse
                                      ?.contains(_model.textController2.text) ==
                                  true) {
