...
class FollowinglistWidget extends StatefulWidget {
  ...
  static String routeName = 'followinglist';
  static String routePath = '/followinglist';
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          widget!.followinglist!.length.toString(),
                          style: FlutterFlowTheme.of(context)
                              .titleSmall
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
                ...
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final followerlist = widget!.followinglist!.toList();
                        ...
                        itemBuilder: (context, followerlistIndex) {
                          ...
                          return Padding(
                            ...
                            child: StreamBuilder<UsersRecord>(
                              stream: UsersRecord.getDocument(followerlistItem),
