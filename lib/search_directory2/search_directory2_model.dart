...
import 'dart:ui';
import '/index.dart';
import 'search_directory2_widget.dart' show SearchDirectory2Widget;
...
class SearchDirectory2Model extends FlutterFlowModel<SearchDirectory2Widget> {
  ...
  ApiCallResponse? recipegoogleoutput;
  // Stores action output result for [Backend Call - API (test)] action in Column widget.
  ApiCallResponse? weblinkoutput;
