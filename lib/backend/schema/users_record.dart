...
class UsersRecord extends FirestoreRecord {
  ...
  // "followRequests" field.
  List<DocumentReference>? _followRequests;
  List<DocumentReference> get followRequests => _followRequests ?? const [];
  bool hasFollowRequests() => _followRequests != null;

  // "unseenNotifications" field.
  int? _unseenNotifications;
  int get unseenNotifications => _unseenNotifications ?? 0;
  bool hasUnseenNotifications() => _unseenNotifications != null;
